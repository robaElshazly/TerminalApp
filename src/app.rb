...
def show_courses_list
  answer=$prompt.select("Here are the courses we offer. If you would like to Enroll,select one",$code_school.print_courses_names)
end  
#-------
def start
...
#------------
puts "#{$code_school.print_courses_names}"
begin 
